...
mod_scores <- scores_dccav(mod, display = c("all"), scaling = "sites")
...
mod_scores <- scores_dccav(mod, display = "all", tidy = TRUE)
names(mod_scores)
...
mod_scores <- scores_dccav(mod3, display = "all", scaling = "symmetric")
str(mod_scores)
...
mod_scores <- scores_dccav(mod3, display = "all", tidy = TRUE)
names(mod_scores)
levels(mod_scores$score)
str(mod_scores)
